                ...
                <div class="col-md-4 ">
                    ...
                    <div class="khung">
                        <div class="text-center mtop-5">
                            <a href="{{route('chitietsanpham',$loai1->id)}}">
                            <img  src="http://localhost/local/resources/upload/{{$loai1->hinh_sp}}" alt=""></a>
                        </div>
                        <div class="text-center border-top mtop-4">
                            ...
                            <div class="my-2">
                                @if($loai1->khuyen_mai==0)
                                <span>{{number_format($loai1->gia)}}</span>
                                @else
                                <del>{{number_format($loai1->gia)}}</del>
                                <span class="">{{number_format($loai1->gia-($loai1->gia*$loai1->khuyen_mai)/100)}}</span>
        ...
        <div class="lefttong border-bottom">
            ...
            <div class="canhle">
                <ul>
                    <li>
                      <?php $t=1?>
                        <a href="{{route('sapxep',[$type,$t])}}">Dưới 5triệu</a>
                    </li>
                    <li class="my-1">
                    <?php $t=2?>
                        <a href="{{route('sapxep',[$type,$t])}}">Từ 5triệu-10triệu</a>
                    </li>
                    <li>
                    <?php $t=3?>
                        <a href="{{route('sapxep',[$type,$t])}}">Từ 10triệu-15triệu</a>
                    </li>
                    <li class="my-1">
                    <?php $t=4?>
                        <a href="{{route('sapxep',[$type,$t])}}">Từ 15triệu-20triệu</a>
                    </li>
                    <li>
                    <?php $t=5?>
                        <a href="{{route('sapxep',[$type,$t])}}">Trên 20triệu</a>
                    </li>
                </ul>
            </div>
        </div>
