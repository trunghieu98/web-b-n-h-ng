        ...
        <div class="col-xs-12 col-md-5 col-lg-5">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form action="{{route('themcuahang')}}" method="post" enctype="multipart/form-data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$nsanxuat->dia_chi}}</td>
                                     <td>
                                        <a href="{{route('suacuahang',$nsanxuat->id)}}" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Sửa</a>
